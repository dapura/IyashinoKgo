package info.dapura.iyashino_kgo.service.impl;
...
import info.dapura.iyashino_kgo.entity.ELoginPassword;
import info.dapura.iyashino_kgo.entity.EUser;
import info.dapura.iyashino_kgo.service.IUserService;
...
public class UserServiceImpl extends JpaDaoBase implements IUserService {
    ...
    /**
     * @see info.dapura.iyashino_kgo.service.IUserService#getAll(jabara.general.Sort)
     */
    @Override
    ...
    /**
     * @see info.dapura.iyashino_kgo.service.IUserService#insertAdministratorIfNotExists()
     */
    @Override
