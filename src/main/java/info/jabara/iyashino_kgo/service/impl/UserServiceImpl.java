...
public class UserServiceImpl extends JpaDaoBase implements IUserService {
    ...
    /**
     * @see info.jabara.iyashino_kgo.service.IUserService#getAll(jabara.general.Sort)
     */
    @Override
    ...
    /**
     * @see info.jabara.iyashino_kgo.service.IUserService#insertAdministratorIfNotExists()
     */
    @Override
